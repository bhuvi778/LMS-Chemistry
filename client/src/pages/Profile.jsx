          ...
          <div className="bg-white rounded-3xl max-w-md w-full shadow-2xl border border-slate-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="font-display text-lg font-bold text-slate-800">Update Phone Number</h3>
                <button
              ...
              {phoneStep === 1 ? (
                <form onSubmit={handleRequestPhoneChange} className="space-y-4">
                  ...
                  <div>
                    <label className="label text-[10px] uppercase font-extrabold tracking-wider text-slate-460">New Phone Number</label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 text-sm font-semibold">+91</span>
                      <input
                        type="tel"
